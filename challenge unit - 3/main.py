...
students1 = [Student("thilak", "19CS001", 9.5), Student("siddharth", "19CS002", 8.7), Student("buvi", "19CS003", 7.8)]
students2 = [Student("abi", "19CS004", 8.9), Student("balaji", "19CS005", 9.2), Student("sibi", "19CS006", 8.4)]
students3 = [Student("mano", "19CS007", 9.1), Student("sridhar", "19CS008", 7.6), Student("hari", "19CS009", 8.2)]
